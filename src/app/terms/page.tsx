...
export const metadata: Metadata = {
  title: "Terms and Conditions | Smart Car Deals",
  description:
    "Smart Car Deals's Terms and Conditions — the rules governing use of our marketplace facilitation platform.",
  alternates: {
    canonical: "/terms",
  },
};
    ...
    <section className="max-w-[860px] mx-auto px-6 py-20">
      ...
      <div className="mb-8 bg-light-bg border border-border rounded-2xl p-6">
        <p className="text-gray-text leading-8">
          Smart Car Deals operates as a disclosed agent and facilitator. By accessing or using our
      ...
      <div className="space-y-6">
        <section className="bg-white border border-border rounded-2xl p-6 shadow-[0_2px_16px_rgba(43,108,245,0.06)]">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-text leading-8">
            <li>
              <strong className="text-navy">&quot;Platform&quot;</strong> means Smart Car Deals and
              the website https://smartcardeals.net/.
            </li>
            <li>
              <strong className="text-navy">&quot;Company&quot;</strong> means Smart Car Deals acting
            ...
            <li>
              ...
              third-party buyer within Smart Car Deals&apos;s dealer network.
            </li>
            <li>
        ...
        <section className="bg-white border border-border rounded-2xl p-6 shadow-[0_2px_16px_rgba(43,108,245,0.06)]">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-text leading-8">
            <li>
              Smart Car Deals operates strictly as a technology-enabled marketplace facilitator and
              service provider.
            </li>
            <li>
            ...
            <li>
              Smart Car Deals acts solely as a disclosed intermediary between Seller and Buyer. The
        ...
        <section className="bg-white border border-border rounded-2xl p-6 shadow-[0_2px_16px_rgba(43,108,245,0.06)]">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-text leading-8">
            ...
            <li>
              Smart Car Deals conducts inspection for information gathering only and does not certify
        ...
        <section className="bg-white border border-border rounded-2xl p-6 shadow-[0_2px_16px_rgba(43,108,245,0.06)]">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-text leading-8">
            ...
            <li>Smart Car Deals is not a party to the sale contract.</li>
          </ul>
        </section>
        ...
        <section className="bg-white border border-border rounded-2xl p-6 shadow-[0_2px_16px_rgba(43,108,245,0.06)]">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-text leading-8">
            <li>Title transfers directly from Seller to Buyer. Smart Car Deals never appears as owner.</li>
            <li>
        ...
        <section className="bg-white border border-border rounded-2xl p-6 shadow-[0_2px_16px_rgba(43,108,245,0.06)]">
          ...
          <p className="text-gray-text leading-8">
            Smart Car Deals may charge Buyer commission or deduct a disclosed service fee. All fees
        ...
        <section className="bg-white border border-border rounded-2xl p-6 shadow-[0_2px_16px_rgba(43,108,245,0.06)]">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-text leading-8">
            <li>
              Smart Car Deals is not liable for mechanical defects, hidden damages, title disputes,
        ...
        <section className="bg-white border border-border rounded-2xl p-6 shadow-[0_2px_16px_rgba(43,108,245,0.06)]">
          ...
          <p className="text-gray-text leading-8">
            Seller and Buyer agree to indemnify Smart Car Deals against claims arising from
